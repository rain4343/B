        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="flex items-center gap-1.5" style={ku}>
              <Hash className="h-3.5 w-3.5" /> ژمارەی بەڵگەنامە
            </FormLabel>
            <FormControl>
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6" dir="rtl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold" style={ku}>بەڵگەنامەی نوێ</h1>
        ...
        <Form {...createForm}>
          <form onSubmit={createForm.handleSubmit(onCreateSubmit)} className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle style={ku}>زانیاری بەڵگەنامە</CardTitle>
                <CardDescription style={ku}>زانیاری سەرەکی بەڵگەنامەکە</CardDescription>
              </CardHeader>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6" dir="rtl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={ku}>دەستکاریکردنی بەڵگەنامە</h1>
          <p className="text-sm text-muted-foreground" style={ku}>
      ...
      <Form {...editForm}>
        <form onSubmit={editForm.handleSubmit(onEditSubmit)} className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle style={ku}>زانیاری بەڵگەنامە</CardTitle>
              <CardDescription style={ku}>زانیاری سەرەکی بەڵگەنامەکە دەستکاری بکە</CardDescription>
            </CardHeader>
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
